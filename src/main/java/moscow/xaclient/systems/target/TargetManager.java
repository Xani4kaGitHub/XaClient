package moscow.xaclient.systems.target;
...
public class TargetManager implements IMinecraft {
   ...
   public void addTarget(String name) {
      if (XaClient.getInstance().getFriendManager().listFriends().contains(name)) {
   ...
   public LivingEntity getLivingTarget() {
      return XaClient.getInstance().getTargetManager().getCurrentTarget() instanceof LivingEntity target2 ? target2 : null;
   }
