      ...
      if (mc.player != null && mc.world != null && entity != null) {
         if (entity instanceof LivingEntity && entity != mc.player) {
            if (entity instanceof LivingEntity living && living.isDead()) {
               ...
               AntiBot antiBotModule = XaClient.getInstance().getModuleManager().getModule(AntiBot.class);
               if (antiBotModule.isRWBot(player)) {
                  return false;
               } else {
                  boolean isFriend = XaClient.getInstance().getFriendManager().isFriend(player.getName().getString());
