...
public class Nametags extends BaseModule {
         ...
         if (entity != mc.player
            ...
            && !(
               entity instanceof PlayerEntity player
                  && XaClient.getInstance().getFriendManager().isFriend(player.getName().getString())
   ...
   public static Text displayName(Entity entity) {
      if (entity.getDisplayName() == null) {
         ...
         NameProtect nameProtectModule = XaClient.getInstance().getModuleManager().getModule(NameProtect.class);
   ...
   private void handleClick(ChatClickEvent event, Entity entity, Vec2f screenPos) {
      ...
      if (GuiUtility.isHovered(
         ...
         FriendManager friendManager = XaClient.getInstance().getFriendManager();
         TargetManager targetManager = XaClient.getInstance().getTargetManager();
