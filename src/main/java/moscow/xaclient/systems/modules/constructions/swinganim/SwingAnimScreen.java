...
import moscow.xaclient.systems.modules.constructions.swinganim.presets.PresetComponent;
...
public class SwingAnimScreen extends CustomScreen implements IScaledResolution, IMinecraft {
   ...
   public SwingAnimScreen() {
      SwingManager manager = XaClient.getInstance().getSwingManager();
      XaClient.getInstance().getSwingPresetManager().refresh();
   ...
   public void close() {
      ...
      super.close();
      mc.setScreen(XaClient.getInstance().getMenuScreen());
   }
}
