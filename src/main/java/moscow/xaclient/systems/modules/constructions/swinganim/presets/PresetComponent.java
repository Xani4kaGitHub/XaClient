...
public class PresetComponent extends CustomComponent {
   ...
   private void create() {
      ...
      for (Setting settingx : XaClient.getInstance().getSwingManager().getEndPhase().getSettings()) {
   ...
   public float getHeight() {
      ...
      return this.height = this.heightAnim
         .update(Math.min(presets.size() * 12 + XaClient.getInstance().getSwingManager().getPresets().size() * 12 - 12, 182) + 46);
   }
}
