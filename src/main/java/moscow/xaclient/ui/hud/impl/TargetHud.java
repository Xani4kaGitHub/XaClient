...
public class TargetHud extends HudElement {
   ...
   protected void renderComponent(UIContext context) {
      ...
      if (this.target != null) {
         ...
         boolean hover = GuiUtility.isHovered(this.x + 34.0F, this.y + 4.0F + 6.0F * this.content.getValue(), 68.0, 8.0, context);
         ...
         if (this.animation.getValue() != 0.0F) {
            ...
            if (this.target instanceof AbstractClientPlayerEntity playerxx) {
               context.drawHead(playerxx, this.x + 7.0F * this.content.getValue(), this.y + 7.0F, 21.0F, BorderRadius.all(3.0F), Colors.WHITE.withAlpha(alpha));
            } else {
               context.drawRoundedTexture(
                  XaClient.id(
                     Interface.glassSelected()
                        ? "icons/hud/whoglass.png"
                        : (XaClient.getInstance().getThemeManager().getCurrentTheme() == Theme.DARK ? "icons/hud/whodark.png" : "icons/hud/who.png")
                  ),
                  this.x + 7.0F * this.content.getValue(),
                  this.y + 7.0F,
                  21.0F,
                  21.0F,
            ...
            context.drawFadeoutText(
               ...
               this.x + 34.0F + 8.0F * this.copy.getValue(),
               this.y + 4.0F + 6.0F * this.content.getValue(),
               Colors.getTextColor().withAlpha(alpha),
               0.7F,
               1.0F,
               this.width - 45.0F - 8.0F * this.copy.getValue() - semibold6.width(numberText)
            );
            RenderUtility.rotate(
               context.getMatrices(),
               this.x + 32.0F + 5.0F * this.copy.getValue(),
               this.y + 7.0F + 6.0F * this.content.getValue(),
               90.0F * this.success.getValue()
            );
            context.drawTexture(
               XaClient.id("icons/hud/copy.png"),
               this.x + 29.0F + 5.0F * this.copy.getValue(),
               this.y + 4.0F + 6.0F * this.content.getValue(),
               6.0F,
               6.0F,
            ...
            context.drawRightText(
               semibold6, numberText, this.x + this.width - 8.0F, this.y + 5.0F + 6.0F * this.content.getValue(), Colors.ACCENT.withAlpha(alpha)
            );
            context.drawRoundedRect(
               this.x + 34.0F,
               this.y + this.height - 7.0F - 6.0F * this.content.getValue(),
               74.0F,
               4.0F,
            ...
            context.drawRoundedRect(
               this.x + 34.0F,
               this.y + this.height - 7.0F - 6.0F * this.content.getValue(),
               74.0F * Math.clamp(this.health.getValue(), 0.0F, 1.0F),
               4.0F,
               BorderRadius.all(0.7F),
               Colors.ACCENT.withAlpha(alpha)
            );
            context.drawRoundedRect(
               this.x + 108.0F - 74.0F * Math.clamp(this.golden.getValue(), 0.0F, 1.0F),
               this.y + this.height - 7.0F - 6.0F * this.content.getValue(),
               74.0F * Math.clamp(this.golden.getValue(), 0.0F, 1.0F),
               4.0F,
               BorderRadius.all(0.7F),
   ...
   private LivingEntity getTarget() {
      LivingEntity mainTarget = XaClient.getInstance().getTargetManager().getCurrentTarget() instanceof LivingEntity target2 ? target2 : null;
      if (mainTarget != null) {
         return mainTarget;
   ...
   public void onMouseClicked(double mouseX, double mouseY, MouseButton button) {
      if (GuiUtility.isHovered((double)(this.x + 34.0F), (double)(this.y + 4.0F + 6.0F * this.content.getValue()), 68.0, 8.0, mouseX, mouseY)) {
