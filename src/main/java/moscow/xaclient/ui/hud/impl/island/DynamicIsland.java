...
import moscow.xaclient.ui.hud.impl.island.impl.BlinkStatus;
import moscow.xaclient.ui.hud.impl.island.impl.DefaultStatus;
import moscow.xaclient.ui.hud.impl.island.impl.EventStatus;
import moscow.xaclient.ui.hud.impl.island.impl.MineStatus;
import moscow.xaclient.ui.hud.impl.island.impl.MusicStatus;
import moscow.xaclient.ui.hud.impl.island.impl.NotificationStatus;
import moscow.xaclient.ui.hud.impl.island.impl.PVPStatus;
import moscow.xaclient.ui.hud.impl.island.impl.XrayStatus;
...
public class DynamicIsland extends HudElement implements IMinecraft, IScaledResolution {
   ...
   public DynamicIsland() {
      ...
      XaClient.getInstance().getFileManager().readFile("client");
   ...
   protected void renderComponent(UIContext context) {
      ...
      if (mc.player != null) {
         ...
         if (!mc.isInSingleplayer() && mc.player.networkHandler.getPlayerListEntry(mc.player.getUuid()) != null) {
            ...
            context.drawTexture(XaClient.id("icons/airplane.png"), this.x + this.width + 8.0F, this.y + 3.5F, 8.0F, 8.0F, elmtColor);
         }
      }
