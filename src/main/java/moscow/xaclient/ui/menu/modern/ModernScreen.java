package moscow.xaclient.ui.menu.modern;
...
import moscow.xaclient.systems.theme.Theme;
import moscow.xaclient.ui.components.ColorPicker;
import moscow.xaclient.ui.components.textfield.FieldAction;
import moscow.xaclient.ui.components.textfield.TextField;
import moscow.xaclient.ui.menu.MenuScreen;
import moscow.xaclient.ui.menu.api.MenuCategory;
import moscow.xaclient.ui.menu.dropdown.components.MenuPanel;
import moscow.xaclient.ui.menu.dropdown.components.settings.impl.BezierSettingComponent;
import moscow.xaclient.ui.menu.dropdown.components.settings.impl.BindSettingComponent;
import moscow.xaclient.ui.menu.dropdown.components.settings.impl.BooleanSettingComponent;
import moscow.xaclient.ui.menu.dropdown.components.settings.impl.ButtonSettingComponent;
import moscow.xaclient.ui.menu.dropdown.components.settings.impl.ColorSettingComponent;
import moscow.xaclient.ui.menu.dropdown.components.settings.impl.ModeSettingComponent;
import moscow.xaclient.ui.menu.dropdown.components.settings.impl.RangeSettingComponent;
import moscow.xaclient.ui.menu.dropdown.components.settings.impl.SliderSettingComponent;
import moscow.xaclient.ui.menu.dropdown.components.settings.impl.StringSettingComponent;
import moscow.xaclient.ui.menu.modern.components.ModernModule;
import moscow.xaclient.ui.menu.modern.components.ModernSettings;
...
import moscow.xaclient.utility.gui.ScrollHandler;
...
import moscow.xaclient.utility.render.batching.impl.FadeOutBatching;
...
import moscow.xaclient.utility.render.batching.impl.RoundedRectBatching;
import moscow.xaclient.utility.render.batching.impl.SquircleBatching;
import moscow.xaclient.utility.render.obj.Rect;
import moscow.xaclient.utility.render.penis.PenisPlayer;
...
public class ModernScreen extends MenuScreen implements IMinecraft, IScaledResolution {
   private static final float CATEGORY_SPACING = 21.0F;
   ...
   public ModernScreen() {
      ...
      for (MenuCategory category : MenuCategory.values()) {
         ...
         try {
            modern.setPenis(new PenisPlayer(XaClient.id("penises/" + category.getName().toLowerCase() + ".penis")));
      ...
      this.searchPenis = new PenisPlayer(XaClient.id("penises/search.penis"));
   ...
   public void render(UIContext context) {
      ...
      boolean dark = XaClient.getInstance().getThemeManager().getCurrentTheme() == Theme.DARK;
      ...
      for (ModernCategory categoryx : this.categories) {
         if (GuiUtility.isHovered(
            ...
            context.drawText(
               ...
               XaClient.getInstance().getThemeManager().getCurrentTheme().getTextColor()
            );
         }
      }
   ...
   public void onMouseClicked(double mouseX, double mouseY, MouseButton button) {
      if (!XaClient.getInstance().getHud().getIsland().handleClick((float)mouseX, (float)mouseY, button.getButtonIndex())) {
         for (ColorPicker colorPicker : this.colorPickers) {
   ...
   public void close() {
      this.closing = true;
      XaClient.getInstance().getModuleManager().getModule(MenuModule.class).disable();
      ...
      if (XaClient.getInstance().getConfigManager().getCurrent() != null) {
         XaClient.getInstance().getConfigManager().getCurrent().save();
      }
