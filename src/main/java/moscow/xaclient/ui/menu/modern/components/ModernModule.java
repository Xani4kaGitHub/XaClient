package moscow.xaclient.ui.menu.modern.components;
...
import moscow.xaclient.ui.menu.modern.ModernCategory;
import moscow.xaclient.ui.menu.modern.ModernScreen;
...
public class ModernModule extends CustomComponent {
   ...
   public void open() {
      if (this.module.getSettings().isEmpty()) {
         ...
         ModernScreen modernScreen = (ModernScreen)XaClient.getInstance().getMenuScreen();
