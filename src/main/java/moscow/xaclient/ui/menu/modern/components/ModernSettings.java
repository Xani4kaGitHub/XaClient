...
public class ModernSettings extends CustomComponent {
   ...
   protected void renderComponent(UIContext context) {
      ...
      boolean check = XaClient.getInstance().getMenuScreen().getMenuAnimation().getValue()
         == XaClient.getInstance().getMenuScreen().getMenuAnimation().getTargetValue();
      ...
      RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, alpha);
      context.drawTexture(XaClient.id("icons/close.png"), x + width - 17.0F, y + 9.0F, 8.0F, 8.0F, Colors.getTextColor());
      ...
      this.backgroundColorAnimation
         .update(
            this.module.getModule().isEnabled()
               ...
               : XaClient.getInstance().getThemeManager().getCurrentTheme().getAdditionalColor()
         );
