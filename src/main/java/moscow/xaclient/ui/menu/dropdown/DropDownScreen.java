package moscow.xaclient.ui.menu.dropdown;
...
import moscow.xaclient.ui.menu.dropdown.components.module.ModuleComponent;
...
import moscow.xaclient.utility.render.batching.impl.RectBatching;
...
public class DropDownScreen extends MenuScreen implements IMinecraft {
   private static final float SEARCH_Y_OFFSET = 46.0F;
   ...
   public void render(UIContext context) {
      ...
      if (searchAlpha > 0.0F) {
         this.searchField.set(this.width / 2.0F - this.searchField.getWidth() / 2.0F, this.height - 20 - SEARCH_Y_OFFSET - 20.0F * searchAlpha, 100.0F, 20.0F);
         ...
         context.drawCenteredText(
            ...
            this.width / 2.0F,
            this.height - 65 - SEARCH_Y_OFFSET - 10.0F * searchAlpha * this.appendingAnim.getValue(),
         ...
         context.drawCenteredText(
            ...
            this.width / 2.0F,
            this.height - 50 - SEARCH_Y_OFFSET - 10.0F * searchAlpha * this.appendingAnim.getValue(),
            ColorRGBA.WHITE.withAlpha(150.0F * searchAlpha * this.appendingAnim.getValue())
         );
      } else {
      ...
      context.drawCenteredText(
         ...
         this.width / 2.0F,
         this.height - 20 - SEARCH_Y_OFFSET - 10.0F * this.menuAnimation.getValue() * (1.0F - this.searchAnimation.getValue()),
