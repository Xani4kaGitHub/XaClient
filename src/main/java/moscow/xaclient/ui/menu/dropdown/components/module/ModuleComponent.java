package moscow.xaclient.ui.menu.dropdown.components.module;
...
public class ModuleComponent extends CustomComponent {
   ...
   public ModuleComponent(Module module, MenuPanel parent) {
      this.module = module;
      this.parent = parent;
      this.enablePenis = new PenisPlayer(XaClient.id("penises/check_enable.penis"));
      this.disablePenis = new PenisPlayer(XaClient.id("penises/check_disable.penis"));
   ...
   protected void renderComponent(UIContext context) {
      ...
      this.blockingColorAnimation
         .update(this.blocking ? new ColorRGBA(255.0F, 150.0F, 150.0F) : XaClient.getInstance().getThemeManager().getCurrentTheme().getTextColor());
   ...
   public void open() {
      if (this.module.getSettings().isEmpty()) {
         if (XaClient.getInstance().getModuleManager().getModule(Sounds.class).isEnabled() && !this.blocking) {
