...
import moscow.xaclient.framework.shader.impl.BlurProgram;
...
import moscow.xaclient.utility.interfaces.IWindow;
...
import moscow.xaclient.utility.render.obj.CustomSprite;
import moscow.xaclient.utility.render.penis.PenisSprite;
...
public final class DrawUtility implements IMinecraft, IWindow {
   ...
   public static void initializeShaders() {
      rectangleProgram = new GlProgram(XaClient.id("rectangle/data"), VertexFormats.POSITION_COLOR);
      squircleProgram = new GlProgram(XaClient.id("squircle/data"), VertexFormats.POSITION_COLOR);
      squircleTextureProgram = new GlProgram(XaClient.id("squircle_texture/data"), VertexFormats.POSITION_TEXTURE_COLOR);
      roundedTextureProgram = new GlProgram(XaClient.id("texture/data"), VertexFormats.POSITION_TEXTURE_COLOR);
      borderProgram = new GlProgram(XaClient.id("border/data"), VertexFormats.POSITION_COLOR);
      loadingProgram = new GlProgram(XaClient.id("loading/data"), VertexFormats.POSITION_COLOR);
      glassProgram = new GlProgram(XaClient.id("liquidglass/data"), VertexFormats.POSITION_TEXTURE_COLOR);
      gradientRectangleProgram = new GlProgram(XaClient.id("gradient_rectangle/data"), VertexFormats.POSITION_COLOR);
   ...
   public static void drawSprite(MatrixStack matrices, CustomSprite sprite, float x, float y, float width, float height, ColorRGBA color) {
      drawTexture(
         matrices,
         XaClient.id(sprite.getTexture().getTexture()),
         x,
         y,
         width,
         height,
