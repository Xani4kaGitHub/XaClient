...
public final class RotationMath implements IMinecraft {
   ...
   public static Vec3d getNearestPoint(LivingEntity entity, Vec3d pos) {
      ...
      double offsetX = pos.x - entity.getX();
      double offsetY = pos.y - entity.getY();
      double offsetZ = pos.z - entity.getZ();
      return new Vec3d(
         MathHelper.clamp(eyePos.x, entity.getBoundingBox().minX + offsetX, entity.getBoundingBox().maxX + offsetX),
         MathHelper.clamp(eyePos.y, entity.getBoundingBox().minY + offsetY, entity.getBoundingBox().maxY + offsetY),
         MathHelper.clamp(eyePos.z, entity.getBoundingBox().minZ + offsetZ, entity.getBoundingBox().maxZ + offsetZ)
      );
   }
