package moscow.xaclient.framework.shader.impl;
...
import moscow.xaclient.utility.render.CustomRenderTarget;
...
public class BlurProgram implements IMinecraft, IWindow {
   ...
   public void initShaders() {
      kawaseDownProgram = new KawaseBlurProgram(XaClient.id("kawase_down/data"));
      kawaseUpProgram = new KawaseBlurProgram(XaClient.id("kawase_up/data"));
   }
